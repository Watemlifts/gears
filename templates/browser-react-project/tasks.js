...
const TYPESCRIPT = "tsc-bundle --project ./script/tsconfig.json --importAs react=React,react-dom=ReactDOM,react-router=ReactRouter,react-router-dom=ReactRouterDOM"
const LESS       = "lessc ./styles/index.less ./dist/index.css"
...
const clean = async () => {
  ...
  await shell("shx rm -rf ./dist/index.css")
